...
class _TotalChartState extends State<TotalChart> {
  ...
  void didChangeDependencies() {
    ...
    currencyNotifier = context.watch<CurrencyNotifier>();
    currencySymbol = currencyNotifier.currencySymbol;
  }

  @override
  Widget build(BuildContext context) {
    return Consumer2<DatabaseProvider, CurrencyNotifier>(
      builder: (_, db, currency, __) {
        var list = db.categories;
        var total = db.calculateTotalExpenses();
              ...
              child: Column(
                ...
                children: [
                  FittedBox(
                    ...
                    fit: BoxFit.scaleDown,
                    child: Text(
                      'Total Expenses: ${NumberFormat.currency(locale: 'en_IN', symbol: currencySymbol).format(total)}',
                      textScaleFactor: 1.5,
                      style: const TextStyle(
                        fontWeight: FontWeight.bold,
                      ),
